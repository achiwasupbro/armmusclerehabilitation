...
class ESP32Controller {
    ...
    handleESP32Connected() {
        ...
        this.scanStatus.textContent = '✅หุ่นยนต์  พร้อมใช้งาน!';
        this.scanStatus.className = 'status success';
    ...
    processVoiceCommand(transcript) {
        ...
        // ตรวจสอบคำสั่ง "แขนขวา" หรือ "right arm"
        if (transcript.includes('แขนขวา') || transcript.includes('right arm') || transcript.includes('ขวา')) {
            console.log('🎤 [DEBUG] ได้ยินคำสั่ง: แขนขวา');
            ...
            // แสดงข้อความ
            voiceStatus.textContent = '🎤 เลือกแขนขวาแล้ว';
        ...
        // ตรวจสอบคำสั่ง "แขนซ้าย" หรือ "left arm"
        if (transcript.includes('แขนซ้าย') || transcript.includes('left arm') || transcript.includes('ซ้าย')) {
            console.log('🎤 [DEBUG] ได้ยินคำสั่ง: แขนซ้าย');
            ...
            // แสดงข้อความ
            voiceStatus.textContent = '🎤 เลือกแขนซ้ายแล้ว';
            voiceStatus.className = 'voice-status success';
...
class HelpController {
    constructor() {
        ...
        this.modalTitle = document.getElementById('helpModalTitle');
        this.modalContent = document.getElementById('helpModalContent');
        this.closeBtn = document.querySelector('.help-modal-close');
        this.helpData = this.getHelpData();
        this.init();
    }

    init() {
        // Event listeners for help buttons - ใช้ capture phase เพื่อจัดการก่อน
        document.addEventListener('click', (e) => {
            if (e.target.classList.contains('help-btn')) {
                e.preventDefault();
                e.stopPropagation();
                e.stopImmediatePropagation(); // หยุดการส่งต่อ event ทันที
                const helpType = e.target.getAttribute('data-help');
                this.showHelp(helpType);
                return false; // หยุดการประมวลผลต่อ
            }
    ...
    getHelpData() {
        return {
            'right-arm': {
                title: 'แขนขวา - รายละเอียดการทำงาน',
                content: `
                    <div class="help-content">
                        <h4>🫱 การเลือกแขนขวา</h4>
                        <p>เมื่อเลือกแขนขวา ระบบจะส่งสัญญาณไปยังมอเตอร์ที่ควบคุมแขนขวาของหุ่นยนต์</p>
                        
                        <div class="help-feature">
                            <h4>✨ คุณสมบัติ</h4>
                            <ul>
                                <li>ควบคุมการเคลื่อนไหวของแขนขวา</li>
                                <li>รองรับการฟื้นฟูกล้ามเนื้อแขนขวา</li>
                                <li>ปรับความเร็วและแรงได้ตามโหมด</li>
                                <li>มีระบบความปลอดภัยป้องกันการบาดเจ็บ</li>
                            </ul>
                        </div>
                        ...
                        <div class="help-steps">
                            ...
                            <ol>
                                <li>กดปุ่ม "แขนขวา" เพื่อเลือก</li>
                                <li>เลือกโหมดการทำงานที่ต้องการ</li>
                                <li>ระบบจะเริ่มทำงานกับแขนขวา</li>
                                <li>สามารถหยุดได้ทุกเมื่อด้วยปุ่มหยุด</li>
                            </ol>
                        </div>

                        <div class="help-warning">
                            <strong>⚠️ ข้อควรระวัง:</strong> ตรวจสอบให้แน่ใจว่าผู้ป่วยนั่งในท่าที่ถูกต้องก่อนเริ่มการฟื้นฟู
                        </div>
                    </div>
                `
            },
            'left-arm': {
                title: 'แขนซ้าย - รายละเอียดการทำงาน',
                content: `
                    <div class="help-content">
                        <h4>🫲 การเลือกแขนซ้าย</h4>
                        <p>เมื่อเลือกแขนซ้าย ระบบจะส่งสัญญาณไปยังมอเตอร์ที่ควบคุมแขนซ้ายของหุ่นยนต์</p>
                        
                        <div class="help-feature">
                            <h4>✨ คุณสมบัติ</h4>
                            <ul>
                                <li>ควบคุมการเคลื่อนไหวของแขนซ้าย</li>
                                <li>รองรับการฟื้นฟูกล้ามเนื้อแขนซ้าย</li>
                                <li>ปรับความเร็วและแรงได้ตามโหมด</li>
                                <li>มีระบบความปลอดภัยป้องกันการบาดเจ็บ</li>
                            </ul>
                        </div>
                        ...
                        <div class="help-steps">
                            <h4>📋 ขั้นตอนการใช้งาน</h4>
                            <ol>
                                <li>กดปุ่ม "แขนซ้าย" เพื่อเลือก</li>
                                <li>เลือกโหมดการทำงานที่ต้องการ</li>
                                <li>ระบบจะเริ่มทำงานกับแขนซ้าย</li>
                                <li>สามารถหยุดได้ทุกเมื่อด้วยปุ่มหยุด</li>
                            </ol>
                        </div>
            ...
            'mode-1': {
                title: 'โหมด 1 - การฟื้นฟูเบื้องต้น',
                content: `
                    <div class="help-content">
                        <h4>🔴 โหมด 1 - การฟื้นฟูเบื้องต้น</h4>
                        <p>โหมดสำหรับผู้ป่วยที่เริ่มต้นการฟื้นฟู หรือมีอาการอ่อนแรงมาก</p>
                        
                        <div class="help-feature">
                            <h4>⚙️ การตั้งค่า</h4>
                            <ul>
                                <li><strong>ความเร็ว:</strong> ช้ามาก (20% ของความเร็วสูงสุด)</li>
                                <li><strong>แรงดัน:</strong> น้อยมาก (30% ของแรงสูงสุด)</li>
                                <li><strong>ระยะเวลา:</strong> 5-10 นาที</li>
                                <li><strong>การเคลื่อนไหว:</strong> นุ่มนวล ไม่กระตุก</li>
                            </ul>
                        </div>
                        ...
                        <div class="help-steps">
                            <h4>🎯 เหมาะสำหรับ</h4>
                            <ul>
                                <li>ผู้ป่วยที่เพิ่งเริ่มการฟื้นฟู</li>
                                <li>ผู้ป่วยที่มีกล้ามเนื้ออ่อนแรงมาก</li>
                                <li>การอบอุ่นกล้ามเนื้อก่อนออกกำลังกาย</li>
                                <li>ผู้สูงอายุที่ต้องการการดูแลพิเศษ</li>
                            </ul>
                        </div>

                        <div class="help-warning">
                            <strong>💡 คำแนะนำ:</strong> เริ่มต้นด้วยโหมดนี้เสมอสำหรับผู้ป่วยใหม่
                        </div>
                    </div>
                `
            },
            'mode-2': {
                title: 'โหมด 2 - การฟื้นฟูระดับกลาง',
                content: `
                    <div class="help-content">
                        <h4>🟡 โหมด 2 - การฟื้นฟูระดับกลาง</h4>
                        <p>โหมดสำหรับผู้ป่วยที่มีความแข็งแรงระดับปานกลาง</p>
                        
                        <div class="help-feature">
                            <h4>⚙️ การตั้งค่า</h4>
                            <ul>
                                <li><strong>ความเร็ว:</strong> ปานกลาง (50% ของความเร็วสูงสุด)</li>
                                <li><strong>แรงดัน:</strong> ปานกลาง (50% ของแรงสูงสุด)</li>
                                <li><strong>ระยะเวลา:</strong> 10-15 นาที</li>
                                <li><strong>การเคลื่อนไหว:</strong> สม่ำเสมอ มีจังหวะ</li>
                            </ul>
                        </div>
                        ...
                        <div class="help-steps">
                            <h4>🎯 เหมาะสำหรับ</h4>
                            <ul>
                                <li>ผู้ป่วยที่ผ่านโหมด 1 มาแล้ว</li>
                                <li>ผู้ป่วยที่มีกล้ามเนื้อแข็งแรงปานกลาง</li>
                                <li>การฟื้นฟูประจำวัน</li>
                                <li>การเสริมสร้างความแข็งแรง</li>
                            </ul>
                        </div>

                        <div class="help-warning">
                            <strong>💡 คำแนะนำ:</strong> สังเกตอาการของผู้ป่วยระหว่างการฟื้นฟู
                        </div>
                    </div>
                `
            },
            'mode-3': {
                title: 'โหมด 3 - การฟื้นฟูระดับสูง',
                content: `
                    <div class="help-content">
                        <h4>🟢 โหมด 3 - การฟื้นฟูระดับสูง</h4>
                        <p>โหมดสำหรับผู้ป่วยที่มีความแข็งแรงดี ต้องการเสริมสร้างกล้ามเนื้อ</p>
                        
                        <div class="help-feature">
                            <h4>⚙️ การตั้งค่า</h4>
                            <ul>
                                <li><strong>ความเร็ว:</strong> เร็ว (75% ของความเร็วสูงสุด)</li>
                                <li><strong>แรงดัน:</strong> สูง (75% ของแรงสูงสุด)</li>
                                <li><strong>ระยะเวลา:</strong> 15-20 นาที</li>
                                <li><strong>การเคลื่อนไหว:</strong> แข็งแรง มีพลัง</li>
                            </ul>
                        </div>
                        ...
                        <div class="help-steps">
                            <h4>🎯 เหมาะสำหรับ</h4>
                            <ul>
                                <li>ผู้ป่วยที่ผ่านโหมด 2 มาแล้ว</li>
                                <li>ผู้ป่วยที่มีกล้ามเนื้อแข็งแรงดี</li>
                                <li>การเสริมสร้างความแข็งแรง</li>
                                <li>การฟื้นฟูขั้นสูง</li>
                            </ul>
                        </div>

                        <div class="help-warning">
                            <strong>⚠️ ข้อควรระวัง:</strong> ใช้เฉพาะผู้ป่วยที่แข็งแรงเพียงพอเท่านั้น
                        </div>
                    </div>
                `
            },
            'mode-4': {
                title: 'โหมด 4 - การฟื้นฟูเข้มข้น',
                content: `
                    <div class="help-content">
                        <h4>🔵 โหมด 4 - การฟื้นฟูเข้มข้น</h4>
                        <p>โหมดสำหรับผู้ป่วยที่มีความแข็งแรงสูง ต้องการการฟื้นฟูเข้มข้น</p>
                        
                        <div class="help-feature">
                            <h4>⚙️ การตั้งค่า</h4>
                            <ul>
                                <li><strong>ความเร็ว:</strong> เร็วมาก (90% ของความเร็วสูงสุด)</li>
                                <li><strong>แรงดัน:</strong> สูงมาก (90% ของแรงสูงสุด)</li>
                                <li><strong>ระยะเวลา:</strong> 20-30 นาที</li>
                                <li><strong>การเคลื่อนไหว:</strong> เข้มข้น ท้าทาย</li>
                            </ul>
                        </div>
                        ...
                        <div class="help-steps">
                            <h4>🎯 เหมาะสำหรับ</h4>
                            <ul>
                                <li>ผู้ป่วยที่ผ่านโหมด 3 มาแล้ว</li>
                                <li>นักกีฬาที่ต้องการฟื้นฟู</li>
                                <li>การเสริมสร้างความแข็งแรงสูงสุด</li>
                                <li>การฟื้นฟูขั้นสูงสุด</li>
                            </ul>
                        </div>

                        <div class="help-warning">
                            <strong>⚠️ ข้อควรระวัง:</strong> ต้องมีผู้เชี่ยวชาญดูแลตลอดเวลา
                        </div>
                    </div>
                `
            },
            'mode-5': {
                title: 'โหมด 5 - หยุดการทำงาน',
                content: `
                    <div class="help-content">
                        <h4>🛑 โหมด 5 - หยุดการทำงาน</h4>
                        <p>ปุ่มหยุดฉุกเฉินสำหรับหยุดการทำงานของระบบทันที</p>
                        
                        <div class="help-feature">
                            <h4>🚨 การทำงาน</h4>
                            <ul>
                                <li>หยุดการทำงานของมอเตอร์ทันที</li>
                                <li>ตัดการเชื่อมต่อกับหุ่นยนต์</li>
                                <li>รีเซ็ตระบบกลับสู่สถานะเริ่มต้น</li>
                                <li>บันทึกข้อมูลการใช้งานล่าสุด</li>
                            </ul>
                        </div>

                        <div class="help-steps">
                            <h4>🆘 เมื่อไหร่ควรใช้</h4>
                            <ul>
                                <li>เมื่อผู้ป่วยรู้สึกไม่สบาย</li>
                                <li>เมื่อเกิดเหตุฉุกเฉิน</li>
                                <li>เมื่อต้องการหยุดการฟื้นฟูทันที</li>
                                <li>เมื่อระบบทำงานผิดปกติ</li>
                            </ul>
                        </div>

                        <div class="help-warning">
                            <strong>🔴 สำคัญ:</strong> ปุ่มนี้จะหยุดการทำงานทันที ไม่มีการยืนยัน
                        </div>
                    </div>
                `
            },
            'voice-control': {
                title: 'การควบคุมด้วยเสียง',
                content: `
                    <div class="help-content">
                        <h4>🎤 การควบคุมด้วยเสียง</h4>
                        <p>ระบบรู้จำเสียงที่ช่วยให้สามารถควบคุมหุ่นยนต์ด้วยคำสั่งเสียงได้</p>
                        
                        <div class="help-feature">
                            <h4>🗣️ คำสั่งที่รองรับ</h4>
                            <ul>
                                <li><strong>"แขนขวา"</strong> - เลือกแขนขวา</li>
                                <li><strong>"แขนซ้าย"</strong> - เลือกแขนซ้าย</li>
                                <li><strong>"โหมดหนึ่ง"</strong> - เลือกโหมด 1</li>
                                <li><strong>"โหมดสอง"</strong> - เลือกโหมด 2</li>
                                <li><strong>"โหมดสาม"</strong> - เลือกโหมด 3</li>
                                <li><strong>"โหมดสี่"</strong> - เลือกโหมด 4</li>
                                <li><strong>"หยุด"</strong> - หยุดการทำงาน</li>
                            </ul>
                        </div>
                        ...
                        <div class="help-steps">
                            <h4>📋 วิธีใช้งาน</h4>
                            <ol>
                                <li>กดปุ่ม "เริ่มฟังคำสั่ง"</li>
                                <li>รอให้ระบบพร้อม (ไฟเขียว)</li>
                                <li>พูดคำสั่งชัดเจน</li>
                                <li>รอให้ระบบประมวลผล</li>
                                <li>ระบบจะทำงานตามคำสั่ง</li>
                            </ol>
                        </div>

                        <div class="help-warning">
                            <strong>💡 เทคนิค:</strong> พูดชัดเจน ไม่เร็วเกินไป และในที่เงียบ
                        </div>
                    </div>
                `
            },
            'camera-control': {
                title: 'AI ตรวจจับนิ้วมือ',
                content: `
                    <div class="help-content">
                        <h4>🤖 AI ตรวจจับนิ้วมือ</h4>
                        <p>ระบบ AI ที่ใช้กล้องตรวจจับการยกนิ้วมือเพื่อควบคุมหุ่นยนต์</p>
                        
                        <div class="help-feature">
                            <h4>✋ การทำงาน</h4>
                            <ul>
                                <li><strong>1 นิ้ว</strong> - เลือกโหมด 1</li>
                                <li><strong>2 นิ้ว</strong> - เลือกโหมด 2</li>
                                <li><strong>3 นิ้ว</strong> - เลือกโหมด 3</li>
                                <li><strong>4 นิ้ว</strong> - เลือกโหมด 4</li>
                                <li><strong>5 นิ้ว</strong> - หยุดการทำงาน</li>
                            </ul>
                        </div>
                        ...
                        <div class="help-steps">
                            <h4>📋 วิธีใช้งาน</h4>
                            <ol>
                                <li>กดปุ่ม "เปิดกล้อง"</li>
                                <li>อนุญาตให้เข้าถึงกล้อง</li>
                                <li>วางมือในกรอบกล้อง</li>
                                <li>ยกนิ้วตามจำนวนที่ต้องการ</li>
                                <li>รอ 3 วินาที ระบบจะทำงาน</li>
                            </ol>
                        </div>

                        <div class="help-warning">
                            <strong>💡 เทคนิค:</strong> ใช้แสงสว่างเพียงพอ และวางมือให้ชัดเจน
                        </div>
                    </div>
                `
            }
    ...
    showHelp(helpType) {
        const helpInfo = this.helpData[helpType];
        if (!helpInfo) return;

        this.modalTitle.textContent = helpInfo.title;
        this.modalContent.innerHTML = helpInfo.content;
